...
function startServer(options) {
    ...
    function validateTextDocument(textDocument) {
        return __awaiter(this, void 0, void 0, function* () {
            const schema = yield Schema_1.PrismaSchema.load(textDocument, documents);
            ...
            for (const [uri, fileDiagnostics] of diagnostics.entries()) {
                yield connection.sendDiagnostics({ uri, diagnostics: fileDiagnostics });
            }
        });
    }
    ...
    connection.onDefinition((params) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (doc) {
            const schema = yield Schema_1.PrismaSchema.load(doc, documents);
